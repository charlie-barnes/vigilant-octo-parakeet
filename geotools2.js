...
/**
 * Modifications by Charlie Barnes July 2009, (charlie@cucaera.co.uk):
 *
 * GT_OSGB.prototype.getGridRef modified to return containing grid reference
 * of point with supplied precision
 *
 * GT_Irish.prototype.getGridRef modified to return containing grid reference
 * of point with supplied precision
 *
 * GT_OSGB.prototype.parseGridRef modified to allow returning 100km square
 * grid references
 *
 * GT_Irish.prototype.parseGridRef modified to allow returning 100km square
 * grid references
*/ 
...
GT_OSGB.suffixes_5km = new Array (
	new Array("SW","SW","SW","SW","SW","NW","NW","NW","NW","NW"),
	new Array("SW","SW","SW","SW","SW","NW","NW","NW","NW","NW"),
	new Array("SW","SW","SW","SW","SW","NW","NW","NW","NW","NW"),
	new Array("SW","SW","SW","SW","SW","NW","NW","NW","NW","NW"),
	new Array("SW","SW","SW","SW","SW","NW","NW","NW","NW","NW"),
	new Array("SE","SE","SE","SE","SE","NE","NE","NE","NE","NE"),
	new Array("SE","SE","SE","SE","SE","NE","NE","NE","NE","NE"),
	new Array("SE","SE","SE","SE","SE","NE","NE","NE","NE","NE"),
	new Array("SE","SE","SE","SE","SE","NE","NE","NE","NE","NE"),
	new Array("SE","SE","SE","SE","SE","NE","NE","NE","NE","NE"));

GT_OSGB.suffixes_2km = new Array (
	new Array("A","A","B","B","C","C","D","D","E","E"),
	new Array("A","A","B","B","C","C","D","D","E","E"),
	new Array("F","F","G","G","H","H","I","I","J","J"),
	new Array("F","F","G","G","H","H","I","I","J","J"),
	new Array("K","K","L","L","M","M","N","N","P","P"),
	new Array("K","K","L","L","M","M","N","N","P","P"),
	new Array("Q","Q","R","R","S","S","T","T","U","U"),
	new Array("Q","Q","R","R","S","S","T","T","U","U"),
	new Array("V","V","W","W","X","X","Y","Y","Z","Z"),
	new Array("V","V","W","W","X","X","Y","Y","Z","Z"));
...
GT_OSGB.prototype.getGridRef = function(precision)
{
    ...
    if (precision == 2000) {
        suffix=GT_OSGB.suffixes_2km[this._zeropad(e, 5).charAt(1)*1][this._zeropad(n, 5).charAt(1)*1];   
        return prefix+this._zeropad(e, 5).substring(0, 1)+this._zeropad(n, 5).substring(0, 1)+suffix;
    } else if (precision == 5000) {
        suffix=GT_OSGB.suffixes_5km[this._zeropad(e, 5).charAt(1)*1][this._zeropad(n, 5).charAt(1)*1];
        return prefix+this._zeropad(e, 5).substring(0, 1)+this._zeropad(n, 5).substring(0, 1)+suffix;
	} else if (precision > 0) {
		return prefix+this._zeropad(e, 5).substring(0, precision)+this._zeropad(n, 5).substring(0, precision);
    } else {
		return prefix;
	}
}
...
GT_OSGB.prototype.parseGridRef = function(landranger)
{
	var ok=false;
	var suffix = false;
    if (landranger.length == 5) {
        suffix = landranger.charAt(4);
        landranger = landranger.substr(0, 4);
    } else if (isAlpha(landranger.charAt(4)) && isAlpha(landranger.charAt(5))) {
        suffix = landranger.charAt(4)+landranger.charAt(5);
        landranger = landranger.substr(0, 4);
    }
	...
	for (precision=5; precision>=0; precision--)
	{
		var pattern = new RegExp("^([STNOHJ][A-Z])\\s*(\\d{"+precision+"})\\s*(\\d{"+precision+"})$", "i")
    ...
    this.eastings = this.eastings + eplus;
    this.northings = this.northings + nplus;
